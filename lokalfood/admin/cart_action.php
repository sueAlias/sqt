...
<tr id="carttable tr">
	...
	<th colspan="3" style="padding-top: 12px; padding-bottom: 12px; text-align: center; background-color: #909090; color: white;" width="15%">Actions</th>
</tr>	
...
foreach ($_SESSION["cart_item"] as $item){
	...
	<td id="#carttable td" style="text-align:center;"><a href="cart_action.php?action=plus&prodID=<?php echo $item["prodID"]; ?>"><i class="fa">&#xf067;</i></a></td>
	<td id="#carttable td" style="text-align:center;"><a href="cart_action.php?action=minus&prodID=<?php echo $item["prodID"]; ?>"><i class="fa">&#xf068;</i></a></td>
	...
	$total_price += ($item["price"]*$item["quantity"] + 5);
	}
	?>

<tr>
<td colspan="2" align="right"><b>Delivery Charge: RM5.00</b></td>
...
<td colspan="3" style="text-align:center;"><button type="submit">Checkout</button></td>
</form>
</tr>
</tbody>
</table>	
